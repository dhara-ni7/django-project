...
function EditApplicant() {
  ...
  const fetchApplicantData = async () => {
    try {
      ...
      console.error("Error causing fetching data", error);
    }
  };
  ...
  const handleSubmit = async(e)=>{
    ...
    try{
      if(connectionData.Load_Applied>200){
        setMessage("Load message cannot be greater than 200");
      ...
      setMessage("Applicant/connection was updated");
        setTimeout(() => {
          setMessage("")
        },3000);
        return;
      ...
      console.error("Error updataing applicant data",error)
    }
  }
